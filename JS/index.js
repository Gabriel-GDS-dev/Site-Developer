...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const projetosWeb = [
    ...
    {
      titulo: "Projeto 9",
      desc: "Descrição do Projeto 9",
      tipo: "Website",
      cor: "card-purple",
    },
    {
      titulo: "Projeto 10",
      desc: "Descrição do Projeto 10",
      tipo: "Website",
      cor: "card-blue",
    },
  ];
  const projetosMobile = [
    {
      titulo: "Projeto M1",
      desc: "Descrição do Projeto M1",
      tipo: "Mobile",
      cor: "card-blue",
    },
    {
      titulo: "Projeto M2",
      desc: "Descrição do Projeto M2",
      tipo: "Mobile",
      cor: "card-orange",
    },
    {
      titulo: "Projeto M3",
      desc: "Descrição do Projeto M3",
      tipo: "Mobile",
      cor: "card-green",
    },
    {
      titulo: "Projeto M4",
      desc: "Descrição do Projeto M4",
      tipo: "Mobile",
      cor: "card-purple",
    },
    {
      titulo: "Projeto M5",
      desc: "Descrição do Projeto M5",
      tipo: "Mobile",
      cor: "card-blue",
    },
    {
      titulo: "Projeto M6",
      desc: "Descrição do Projeto M6",
      tipo: "Mobile",
      cor: "card-orange",
    },
    {
      titulo: "Projeto M7",
      desc: "Descrição do Projeto M7",
      tipo: "Mobile",
      cor: "card-green",
    },
    {
      titulo: "Projeto M8",
      desc: "Descrição do Projeto M8",
      tipo: "Mobile",
      cor: "card-purple",
    },
    {
      titulo: "Projeto M9",
      desc: "Descrição do Projeto M9",
      tipo: "Mobile",
      cor: "card-blue",
    },
    {
      titulo: "Projeto M10",
      desc: "Descrição do Projeto M10",
      tipo: "Mobile",
      cor: "card-orange",
    },
  ];
  ...
  function setupCarousel(
    ...
    function updateView() {
      ...
      cards.forEach((card, i) => {
        card.style.display =
          i >= start && i < start + visibleCount ? "flex" : "none";
      });
  ...
  // Web
  const webLeft = document
    .querySelectorAll(".carousel-container")[0]
    .querySelector(".carousel-arrow.left");
  const webRight = document
    .querySelectorAll(".carousel-container")[0]
    .querySelector(".carousel-arrow.right");
  setupCarousel("carousel-web", projetosWeb, webLeft, webRight, 4);

  // Mobile
  const mobLeft = document
    .querySelectorAll(".carousel-container")[1]
    .querySelector(".carousel-arrow.left");
  const mobRight = document
    .querySelectorAll(".carousel-container")[1]
    .querySelector(".carousel-arrow.right");
